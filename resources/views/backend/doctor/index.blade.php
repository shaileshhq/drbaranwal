            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-xl-2">
                        <a href="{{ route('doctor.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            @foreach ($doctor as $key=>$item)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><img src="{{asset('public/storage/doctor/' .$item->image)}}" style="width:50px;"></td>
                                    <td>{{ $item->name }}</td>
                                    <td>{{$item->designation}}</td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ route('doctor.edit', $item->id) }}" class="">
