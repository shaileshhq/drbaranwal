                        ...
                        <form method="POST" action="{{ route('doctor.update', $doctor->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    @enderror
                                    <label for="formFile">
                                        <img src="{{ asset('public/storage/doctor/' . $doctor->image) }}" width="100%"
                                            height="100">
                                    </label>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="designation" id="designation"
                                        placeholder="Enter Your Designation" value="{{ $doctor->designation }}">
                                    @error('designation')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="3">{{ $doctor->description }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
