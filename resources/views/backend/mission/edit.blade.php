            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('mission.index') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        ...
                        <form method="POST" action="{{ route('mission.update', $mission->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    @enderror
                                    <label for="formFile">
                                        <img src="{{ asset('public/storage/mission/' . $mission->icon) }}" width="100%"
                                            height="100">
                                    </label>
                                </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="3">{{ $mission->description }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
