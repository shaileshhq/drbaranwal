            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('slider.index') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        ...
                        <form method="POST" action="{{ route('slider.update', $slider->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    @enderror
                                    <label for="formFile">
                                        <img src="{{ asset('public/storage/slider/' . $slider->image) }}" width="100%"
                                            height="100">
                                    </label>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label for="short_desc" class="form-label">Description</label>
                                    <textarea class="form-control" name="short_desc" id="short_desc" rows="3">{{ $slider->short_desc }}</textarea>
                                    @error('short_desc')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
