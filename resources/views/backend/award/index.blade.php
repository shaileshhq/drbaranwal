            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-xl-2">
                        <a href="{{ route('award.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                            <i class="bx bxs-plus-square"></i>Add Award
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            ...
                                            <form action="{{ route('award.destroy', $item->id) }}" method="POST">
                                                @method('Delete')
                                                @csrf
