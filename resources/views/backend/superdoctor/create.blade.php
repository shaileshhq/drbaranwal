            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">SuperSpecialist Doctor</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-lg-12 col-xl-10">
                        <h3>Add SuperSpecialist Doctor</h3>
                    </div>
                </div>
            </div>
            <div class="card-body p-4">
                <div class="form-body mt-4">
                    <div class="border border-3 p-4 rounded">
                        <form method="post" action="{{ route('superdoctor.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
