            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-xl-3 text-end">
                        <a href="{{ route('service.create') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            @foreach ($service as $key=>$item)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><img src="{{asset('public/storage/service/' .$item->image)}}" style="width:150px;"></td>
                                    <td>{{ $item->title }}</td>
                                    <td>{{$item->short_desc}}</td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ route('service.edit', $item->id) }}" class="">
