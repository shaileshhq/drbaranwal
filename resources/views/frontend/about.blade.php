...
@section('content')
    ...
    <!-- Breadcrumb End -->
    <!-- About Section Start -->
    <div class="feature-wrap ptb-100">
                        ...
                        <div class="sidebar-widget style-two">
                            <div class="single-team-widget">
                                ...
                                <div class="single-team-info">
                                    ...
                                    <p>Senior Consultant Endodontist Cosmetic Dental Surgeon & Certifed Implantologist
                                        Former Sr. Resident (IMS, BHU) Former SRF (P), DRDO (DEFENCE) </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-8 order-xl-2 order-lg-1 order-md-1 order-1">
                    <div class="team-desc">
                        <div class="single-para">
                            ...
                            <p>We are proud to introduce Dr. AK Baranwal, our senior consultant specializing in endodontics,
                                cosmetic dentistry, and dental implants. With a distinguished background including roles as
                                Senior Resident at IMS, BHU. Dr. Baranwal brings extensive expertise to our practice. His
                                dedication to precision and patient care ensures that every individual receives
                                comprehensive and compassionate dental treatment.</p>
                            <a href="{{ route('index') }}#appointment" class="btn-two">Make an Appointment</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="testimonial-wrap style-one ptb-100">
        <img src="{{ asset('public/frontend_css/assets/img/shape-2.webp') }}" alt="Image"
            class="testimonial-shape-one moveHorizontal sm-none">
        ...
        <div class="container">
            <div class="row mb-40">
                <div class="col-xxl-6 col-xl-7 col-md-9">
                    <div class="section-title style-one">
                        <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}"
                                alt="Image">Patients Review</span>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card style-one">
                            <div class="client-quote">
                                <img src="{{ asset('public/frontend_css/assets/img/clients/quote-2.svg') }}"
                                    alt="Image" class="quote-icon">
                                <p>Dr A.K Baranwal provided exceptional braces treatment.clear explanation minimal
                                    ...
                                    excellent post treatment care. worthwhile investment for a confident smile, highly.</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card style-one">
                            <div class="client-quote">
                                <img src="{{ asset('public/frontend_css/assets/img/clients/quote-2.svg') }}"
                                    alt="Image" class="quote-icon">
                                <p>I have been a patient at this clinic for several years, and I can't speak highly enough
                                    of
                                    the exceptional care I've received. The expertise in endodontics and cosmetic dentistry
                                    is
                                    truly unmatched. The entire staff is professional, compassionate, and always attentive
                                    to my
                                    needs.</p>
                            </div>
                            <div class="client-info">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card style-one">
                            <div class="client-quote">
                                <img src="{{ asset('public/frontend_css/assets/img/clients/quote-2.svg') }}"
                                    alt="Image" class="quote-icon">
                                <p>Dr A.K Baranwal and his staff are excellent. They are professional and they take the time
                                    to explain everything to us.he is very polite,caring and supportive with everyone.</p>
                            </div>
                            <div class="client-info">
                                <div class="client-img">
                                    <img src="{{ asset('public/frontend_css/assets/img/user-2.png') }}" alt="Image">
