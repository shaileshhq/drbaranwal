...
@section('content')
    ...
    <div class="hero-wrap style-one">
        ...
        <img src="{{ asset('public/frontend_css/assets/img/hero/hero-shape-3.webp') }}" alt="Image"
            class="hero-shape-three moveHorizontal md-none">
        <img src="{{ asset('public/frontend_css/assets/img/hero/hero-shape-4.webp') }}" alt="Image"
            class="hero-shape-four bounce md-none">
        <img src="{{ asset('public/frontend_css/assets/img/hero/hero-shape-5.webp') }}" alt="Image"
            class="hero-shape-five">
        <div class="container">
            <div class="row align-items-center gx-5">
                <div class="col-xl-7 col-lg-6">
                    <div class="hero-content">
                        <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}"
                                alt="Image">Dental Care For Everyone</span>
                        <h1>Dr A K Baranwal <br><span> BDS, MDS (Gold medalist)!</span></h1>
                        <p>Discover the path to your perfect smile with the premier dental experts at Dr A.K Baranwal
                            Dentistry. Our skilled team is dedicated to delivering exceptional results and personalized
                            care, ensuring your journey to a radiant smile.</p>
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="hero-img-wrap">
                        <div class="hero-promo-box">
                            <span><img src="{{ asset('public/frontend_css/assets/img/hero/promo-img.webp') }}"
                                    alt="Image"></span>
                        ...
                        <img src="{{ asset('public/frontend_css/assets/img/hero/drbaranwal.png') }}" alt="Image"
                            class="hero-img">
                    </div>
                </div>
            </div>
    ...
    <div class="feature-wrap mt-0">
        <img src="{{ asset('public/frontend_css/assets/img/about/about-shape-6.webp') }}" alt="Image"
            class="feature-shape">
        <div class="about-wrap style-three pb-100">
            <div class="container">
                <img src="{{ asset('public/frontend_css/assets/img/about/about-shape-3.webp') }}" alt="Image"
                    class="about-shape-one moveHorizontal">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img-wrap">
                            <img src="{{ asset('public/frontend_css/assets/img/about/about-img-5.webp') }}" alt="Image"
                                class="about-img-one">
                            <img src="{{ asset('public/frontend_css/assets/img/about/about-img-4.webp') }}" alt="Image"
                                class="about-img-two">
                            <div class="promo-box">
                                <h5>95%</h5>
                    ...
                    <div class="col-lg-6 pe-xxl-0">
                        <div class="about-content">
                            ...
                            <a href="#appointment" class="btn-two">Make An Appointment<i
    ...
    <div class="service-wrap style-two bg_optional ptb-100">
        <div class="container">
            <img src="{{ asset('public/frontend_css/assets/img/services/service-shape-1.webp') }}" alt="Image"
                class="service-shape moveHorizontal">
            <img src="{{ asset('public/frontend_css/assets/img/services/service-shape-3.webp') }}" alt="Image"
                class="service-shape-two bounce">
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div class="content-title style-one text-center mb-40">
                        <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}"
                                alt="Image">Dental Care Services</span>
            ...
            <div class="service-slider-wrap">
                ...
                <div class="service-slider-btn slider-btn">
                    <div class="service-prev prev-btn"><img
                            src="{{ asset('public/frontend_css/assets/img/left-arrow.svg') }}" alt="Image"></div>
                    <div class="service-next next-btn"><img
                            src="{{ asset('public/frontend_css/assets/img/right-arrow.svg') }}" alt="Image"></div>
                </div>
            </div>
            <p class="section-subtitle style-two mt-50 d-block w-100 text-center">Click any of the above services to learn
                more <a href="{{ route('service') }}" class="link-one">View Our All Services</a></p>
        </div>
    </div>
    <!-- Service Section End -->
    ...
    <div class="wh-wrap style-one ptb-100">
        <div class="container">
            <img src="{{ asset('public/frontend_css/assets/img/about/wh-shape-3.webp') }}" alt="Image"
                class="wh-shape-one">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    <div class="wh-content">
                        <div class="content-title style-one">
                            <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}"
                                    alt="Image">Why Choose Us</span>
                            <h2>Why Choose <span>"Dr A K Baranwal" </span>
                                For All Dental Treatment in Varanasi.</h2>
                            <p>At Dr A K Baranwal, we take pride in providing our customers with satisfactory treatments for
                                all their dental problems. Our dental clinics in Varanasi are equipped with advanced
                                technology and modern equipment, making us one of the best dental hospitals in Varanasi. We
                                have a team of the best dentists in Varanasi, holding years of experience in a wide range of
                                dental treatments in Delhi such as microscopic dentistry, orthodontic treatments,
                                periodontics, pediatric dentistry, and many others at a cost that suits your budget. Your
                                safety is our priority, and we follow a strict protocol for the sanitization of all our
                                equipment after every patient’s consultation or treatment session.</p>
                        </div>
                    ...
                    <div class="wh-img-wrap">
                        ...
                        <div class="circle-wrap">
                            ...
                            <div class="circle-text">
                                <svg class="rotate" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%"
                                    height="100%" viewBox="0 0 300 300" enable-background="new 0 0 300 300"
                                    xml:space="preserve">
                                    <defs>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="before-after-container">
                            ...
                            <input oninput="callBeforeAfter()" onchange="callBeforeAfter()" type="range"
                                min="0" max="100" value="50" id="before_after_slider">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-40">
                <div class="col-xl-12 col-md-12">
                    <div class="section-title style-one text-center">
                        <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}"
                                alt="Image">Professional Dentists</span>
    ...
    <div class="testimonial-wrap style-one pt-100 pb-75">
        <img src="{{ asset('public/frontend_css/assets/img/bg-shape-1.webp') }}" alt="Image"
            class="testimonial-bg-shape">
        <div class="container">
            <div class="row mb-40">
                <div class="col-xxl-6 col-xl-8 col-lg-7 col-md-8">
                    <div class="section-title style-one ">
                        <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}" alt="Image">
                            Patients Review</span>
                        <h2>Valuable Feedback From Our <span>Patients</span></h2>
                    </div>
                </div>
                <div class="testimonial-slider-btn slider-btn">
                    <div class="testimonial-prev prev-btn"><img
                            src="{{ asset('public/frontend_css/assets/img/left-arrow.svg') }}" alt="Image"></div>
                    <div class="testimonial-next next-btn"><img
                            src="{{ asset('public/frontend_css/assets/img/right-arrow.svg') }}" alt="Image"></div>
                </div>
            </div>
                            ...
                            <div class="testimonial-card style-two">
                                ...
                                <div class="client-info-wrap">
                                    <div class="client-img">
                                        <img src="{{ asset('public/frontend_css/assets/img/user-2.png') }}"
                                            alt="Image">
                                    </div>
                                ...
                                <div class="client-quote">
                                    ...
                                    <p>Dr A.K Baranwal provided exceptional braces treatment.clear explanation minimal
                                        discomfort and effective results within the estimated time. proffesional staff and
                                        excellent post treatment care. worthwhile investment for a confident smile, highly.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial-card style-two">
                                ...
                                <div class="client-quote">
                                    ...
                                    <p>I have been a patient at this clinic for several years, and I can't speak highly
                                        enough of
                                        the exceptional care I've received. The expertise in endodontics and cosmetic
                                        dentistry is
                                        truly unmatched. The entire staff is professional, compassionate, and always
                                        attentive to my
                                        needs.</p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-card style-two">
                                ...
                                <div class="client-quote">
                                    ...
                                    <p>Dr A.K Baranwal and his staff are excellent. They are professional and they take the
                                        time to explain everything to us.he is very polite,caring and supportive with
                                        everyone.</p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="blog-wrap style-one pt-100 pb-75 bg_optional">
        <div class="container">
            <img src="{{ asset('public/frontend_css/assets/img/blog/blog-shape-1.webp') }}" alt="Image"
                class="blog-shape sm-none bounce">
            <div class="row">
                <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div class="section-title style-one text-center mb-40">
                        <span><img src="{{ asset('public/frontend_css/assets/img/section-shape.svg') }}"
                                alt="Image">Our Latest Articles</span>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="blog-card style-one">
                            ...
                            <div class="blog-card-info">
                                <a href="{{ route('blog.detail', $blog->slug) }}" class="blog-date"><i
                                        class="flaticon-calendar"></i>{{ $blog->created_at->format('d M Y') }}</a>
