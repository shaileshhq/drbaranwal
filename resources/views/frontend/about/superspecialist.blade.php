    ...
    <div class="breadcrumb-wrap bg-f br-2">
        ...
        <div class="container">
            <div class="breadcrumb-content">
                <h2>Our Super Specialist Doctor</h2>
                <ul class="breadcrumb-menu list-style">
                    <li><a href="{{route('index')}}">Home</a></li>
                    <li>Our Super Specialist Doctor</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="row mb-40">
                    ...
                    <div class="team-slider-btn slider-btn">
                        ...
                        <div class="team-next next-btn swiper-button-disabled" tabindex="-1" role="button"
                            ...
                            <img src="{{ asset('public/frontend_css/assets/img/right-arrow.svg') }}" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="team-card-wrap">
                    <div class="team-slider swiper">
                        <div class="swiper-wrapper">
                            @foreach ($superspecialist as $item)
                                <div class="swiper-slide">
                                    <div class="team-card style-two">
                                        <div class="team-img">
                                            <img src="{{ asset('public/storage/superspecialist/' . $item->image) }}" alt="Image">
                                        </div>
                                        <div class="team-info">
